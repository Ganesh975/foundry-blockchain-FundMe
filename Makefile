...
deploy-sepholia:
	...
	forge script script/DeployFundme.s.sol:depolyfundme --rpc-url $(sepholia_rpc_url) --private-key $(sepholia_private_key) --broadcast --verify --etherscan-api-key $(etherscan_apikey) -vvv
